...
CREATE TABLE IF NOT EXISTS `biome1m_documentos_eqt` (
  `doceqt_id` INT NOT NULL AUTO_INCREMENT,
  `biome1m_tipoequipos_eqt_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `biome1m_msgserclient` (
  `msgserclient_id` INT NOT NULL AUTO_INCREMENT,
  ...
  `msgserclient_leido` TINYINT NULL,
...
CREATE TABLE IF NOT EXISTS `biome1m_msgserv` (
  `msgserv_id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `biome1m_msgsoftw` (
  `msgsoftw_id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `biome1m_novedades` (
  `nov_id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `biome1m_software` (
  `softw_id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `biome1m_usuarios` (
  ...
  `usuarios_fechamodifi` DATETIME NULL,
